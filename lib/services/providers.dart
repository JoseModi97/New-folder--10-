...
final darajaConfigProvider = Provider<DarajaConfig>((ref) {
  return DarajaConfig(
    ...
    consumerKey: _requireEnv('DARAJA_CONSUMER_KEY'),
    consumerSecret: _requireEnv('DARAJA_CONSUMER_SECRET'),
    ...
    baseUrl: dotenv.maybeGet('DARAJA_BASE_URL') ?? 'https://sandbox.safaricom.co.ke',
  );
});
